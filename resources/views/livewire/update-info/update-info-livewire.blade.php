	...
	<div class="col-12">
		...
		<div class="row px-3">
			...
			<div class="col-12 col-md-12">
				<div class="form-group">
					<label class="col-form-label text-indigo" for="zalo_phone">Số điện thoại tài khoản Zalo:</label>
					<div id="zalo_phone_div">
						<input type="text" class="form-control px-2" wire:key="zalo_phone" wire:model.lazy="zalo_phone" id="zalo_phone" style="width: 100%" placeholder="Số điện thoại tài khoản Zalo ..." autocomplete="off">
					</div>
					@error('zalo_phone')
						<label class="pl-1 small invalid-feedback d-inline-block"><i class="fas mr-1 fa-exclamation-circle"></i>{{ $message }}</label>
					@enderror
